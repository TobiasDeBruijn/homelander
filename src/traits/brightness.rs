...
pub trait Brightness {
    ...
    fn is_command_only_brightness(&self) -> Result<bool, CombinedDeviceError<Self::Error>>;

    /// Current brightness level of the device.
    fn get_brightness(&self) -> Result<i32, CombinedDeviceError<Self::Error>>;

    /// New absolute brightness percentage.
    fn set_brightness_absolute(&mut self, brightness: i32) -> Result<(), CombinedDeviceError<Self::Error>>;

    /// The exact percentage of brightness to change.
    fn set_brightness_relative_percent(&mut self, brightness: i32) -> Result<(), CombinedDeviceError<Self::Error>>;
    ...
    fn set_brightness_relative_weight(&mut self, weight: i32) -> Result<(), CombinedDeviceError<Self::Error>>;
}